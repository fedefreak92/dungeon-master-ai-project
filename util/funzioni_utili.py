...
def statistiche(gioco, g):
    """Displays the character's statistics.

    Shows the name, class, level, HP, gold, ability scores (including modifiers),
    defense, and experience points of the given character.

    Args:
        gioco: The game object.
        g: The character whose stats are to be displayed.
    """
